...
import { getAllUsers, updateUser, bulkDeleteUsers, resetUserPassword, forceLogoutUser, getUserDetails, getStudentProgress, getUserCalendarData, getUserLearningStats } from '../controllers/adminController.js';
...
router.get('/users/:id/calendar', protect, admin, getUserCalendarData);
router.get('/users/:id/stats', protect, admin, getUserLearningStats);
